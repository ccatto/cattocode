    ...
    if (multiFields || singleField) {
      return (0, _core.jsx)(_core.ClassNames, null, ({
        ...
        className: cx(classNameWrapper, css(_templateObject(), styleStrings.objectWidgetTopBarContainer), {
          ...
          [css(_templateObject3(), _netlifyCmsUiDefault.colors.textFieldBorder)]: forList ? !hasError : false
        })
        ...
        className: cx({
          [css(_templateObject4(), styleStrings.collapsedObjectControl)]: collapsed
        })
