...
class API {
  ...
  async getBranch(branchName) {
    const branch = await this.requestJSON("".concat(this.repoURL, "/repository/branches/").concat(encodeURIComponent(branchName)));
    return branch;
  }
  ...
  async uploadAndCommit(items, {
    ...
    try {
      ...
      if (newBranch && message.includes("Could not update ".concat(branch))) {
