...
class GraphQLAPI extends _API.default {
  ...
  async mutate(options) {
    try {
      ...
      if (Array.isArray(errors) && errors.some(e => e.message === 'Ref cannot be created.')) {
      ...
      } else if (Array.isArray(errors) && errors.some(e => new RegExp("A ref named \"refs/heads/".concat(_netlifyCmsLibUtil.CMS_BRANCH_PREFIX, "/.+?\" already exists in the repository.")).test(e.message))) {
        ...
        if (branchName && branchName.startsWith("".concat(_netlifyCmsLibUtil.CMS_BRANCH_PREFIX, "/")) && sha) {
          try {
